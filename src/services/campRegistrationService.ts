...
export const campRegistrationService = {
  async createRegistration(data: Omit<CampRegistration, 'id' | 'registration_number' | 'created_at' | 'updated_at'>) {
    // Generate a temporary ID for client-side use (DB will assign real ID)
    const tempId = crypto.randomUUID();
    const insertData = { ...toDb(data), id: tempId };
    ...
    return {
      id: tempId,
      ...data,
      registration_number: '', // Will be auto-generated by DB trigger
