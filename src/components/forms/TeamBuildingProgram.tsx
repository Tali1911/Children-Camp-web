          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Create safe, fun, memory-filled experiences with measurable outcomes. Each package is 90% fun + 10%
                reflection, focusing on team communication and problem-solving.
              </p>
            </div>

            <div className="relative h-80 rounded-2xl overflow-hidden">
              <img src={birthdayImage} alt="Team building activities" className="w-full h-full object-cover" />
            ...
            <Card className="p-6 bg-accent/50">
              ...
              <div className="space-y-2 text-muted-foreground">
                <p>
                  <strong>Arrival Icebreaker</strong> - Welcome activities and team formation
                </p>
                <p>
                  <strong>Obstacle Challenge</strong> - Physical and mental challenges
                </p>
                <p>
                  <strong>Water Game</strong> - Fun water-based team activities
                </p>
                <p>
                  <strong>Treasure Hunt</strong> - Problem-solving adventure
                </p>
                <p>
                  <strong>Cake & Awards</strong> - Celebration and recognition
                </p>
                <p>
                  <strong>Closing Circle</strong> - Reflection and key takeaways
                </p>
              </div>
            </Card>
          </div>
